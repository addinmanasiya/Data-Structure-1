...
class List:
    ...
    def _reverse_r_aux(self, previous, current):  # Not present
        """
        -------------------------------------------------------
        Reverses the order of the elements in list.
        (recursive algorithm)
    ...
    def _split_alt_r_aux(self, target1, target2, even):  # Not present
        """
        -------------------------------------------------------
        Split a list into two parts. even contains the even indexed
        elements, odd contains the odd indexed elements. At finish
    ...
    def _linear_search_r_aux(self, i, c, p, key):  # Not Present
        """
        -------------------------------------------------------
        Searches for the first occurrence of key in the list.
        Private helper methods - used only by other ADT methods.
    ...
    def _intersection_r_aux(self, index, current, source1, source2):  # Not Present
        """
        -------------------------------------------------------
        Update the current list with values that appear in both
        source1 and source2. Values do not repeat. source1 and
    ...
    def _union_r_aux(self, select, index, current, source1, source2):  # Not present
        """
        -------------------------------------------------------
        Update the current list with all values that appear in
        source1 and source2. Values do not repeat. source1 and
